...
![images](../../gitbook/markdownImages/img001.png)
...
**浏览器发送请求，若请求地址符合前端控制器的url-pattern，该请求就会被前端控制器DispatcherServlet处理。前端控制器会读取SpringMVC的核心配置文件，通过扫描组件找到控制器，将请求地址和控制器中@RequestMapping注解的value属性值进行匹配，若匹配成功，该注解所标识的控制器方法就是处理请求的方法。处理请求的方法需要返回一个字符串类型的视图名称，该视图名称会被视图解析器解析，加上前缀和后缀组成视图的路径，通过Thymeleaf（视图解析器）对视图进行渲染，最终转发到视图所对应页面**
...
![](../../gitbook/markdownImages/img002.png)
...
![image-20210706201316593](../../gitbook/markdownImages/img003.png)
...
![image-20210706201602267](../../gitbook/markdownImages/img004.png)
...
![images](../../gitbook/markdownImages/img005.png)
...
![image-20210709214911404](../../gitbook/markdownImages/img006.png)

![image-20210709214947432](../../gitbook/markdownImages/img007.png)

iii. 如果有配置，则访问目标资源（一般为静态资源，如：JS,CSS,HTML），找不到客户端也会展示404错误

![image-20210709215255693](../../gitbook/markdownImages/img008.png)

![image-20210709215336097](../../gitbook/markdownImages/img009.png)
...
除此之外，我们再来看看 Spring 中的命名空间，见上面例子。 可以发现在最基本的配置中，含有 xmlns, xmlns:xsi, xsi:schemaLocation 三项，这三项是 Spring 最基本的命名空间，其含义如下：
...
[Spring 配置文件之引入命名空间](https://link.zhihu.com/?target=https%3A//blog.csdn.net/hhx_echo/article/details/76095840)
[XML 命名空间](https://link.zhihu.com/?target=http%3A//www.w3school.com.cn/xml/xml_namespaces.asp)
